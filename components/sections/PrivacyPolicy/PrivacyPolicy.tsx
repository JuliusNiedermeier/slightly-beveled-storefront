  ...
  return (
    <Container>
      <div className={styles.document}>
        <Typography type="heading-md">Datenschutzerklärung</Typography>
        ...
        <p>
          Telefon: +49 176 4074 2728
          <br />
          E-Mail: info@slightly-beveled.com
        </p>
        <p>
        ...
        <p>
          ...
          SEI DENN, WIR K&Ouml;NNEN ZWINGENDE SCHUTZWÜRDIGE GRÜNDE FÜR DIE
        ...
        <p>
          ...
          Endgerät gespeichert, bis Sie diese selbst löschenoder eine
